  ...
  return (
    ...
    >
      <svg
        width="100%"
        height="auto"
        viewBox="0 20 180 208"
        aria-hidden="true"
        focusable="false"
        preserveAspectRatio="xMidYMid meet"
        style={{
          display: "block",
          width: "min(100%, var(--app-figure-size, 156px))",
      ...
      >
        ...
        <path
          ...
          fill={`url(#${uid}-layer)`}
          opacity={hasLayer ? "1" : "0.12"}
          style={fillMotion}
        />
        <path d="M68 82c6-7 13-10 22-10s16 3 22 10l-8 77H76L68 82Z" fill={`url(#${uid}-top)`} style={fillMotion} />
        <path d="M70 85c7-8 13-11 20-11s13 3 20 11l-2 17H72l-2-17Z" fill={`url(#${uid}-weave)`} opacity="0.2" style={surfaceMotion} />
        {hasLayer ? (
          <>
        ...
        <path d="M75 172h29l6 39H93l-3-29-5 29H68l7-39Z" fill={`url(#${uid}-weave)`} opacity="0.13" style={surfaceMotion} />
        <path d="M85 183l5-15 3 48h-7l-4-34 3 1Z" fill={socksFill} opacity="0.32" style={fillMotion} />
        ...
        <path d="M68 88c-9 18-13 36-13 55" stroke={T.bgCard} strokeWidth="2" strokeLinecap="round" opacity="0.24" fill="none" />
        <path d="M112 88c9 18 13 36 13 55" stroke={T.bgCard} strokeWidth="2" strokeLinecap="round" opacity="0.24" fill="none" />
        <path d="M76 93h28" stroke={T.bgCard} strokeWidth="2" strokeLinecap="round" opacity="0.3" fill="none" />
      </svg>
    </div>
  );
}
